...
def predict():
    ...
    if (prediction == 1):
        return render_template('nochance.html',prediction='ypu have a liver desease problem')
    else:
        return render_template('chance.html',prediction='ypu dont have a liver desease problem')
